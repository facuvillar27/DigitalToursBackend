...
public class JwtService {
    ...
    public String generateToken(UserEntity user) {
        return Jwts.builder()
                .setSubject(user.getUsername())  // Asigna el nombre de usuario al "sub"
                .claim("roles", user.getRole())  // Asigna el rol al "roles"
                .claim("id", user.getId())  // Agrega el campo id al payload
